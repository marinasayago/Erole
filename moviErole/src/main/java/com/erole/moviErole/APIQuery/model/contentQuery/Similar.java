...
public class Similar {
    ...
    public boolean equals(Object other) {
        ...
        return ((((((this.imDbRating == rhs.imDbRating)||((this.imDbRating!= null)&&this.imDbRating.equals(rhs.imDbRating)))&&((this.image == rhs.image)||((this.image!= null)&&this.image.equals(rhs.image))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))));
    }
